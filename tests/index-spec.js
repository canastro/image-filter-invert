...
describe('index', function () {
   ...
   afterEach(function () {
    ...
    it('should throw error by missing parameters', function () {
        ...
        expect(fn).to.throw(/image-filter-invert:: invalid options provided/);
    });

    it('should apply invert transformation and return as imageData', function () {
        var imageData = {
    ...
    it('should apply invert transformation and return as dataURL', function() {
        var imageData = {
            data: [193, 219, 242, 255]
        };
